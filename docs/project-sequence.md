...
| 4 | **SolGeo Segment** | Human-correctable feature extraction and vector export | [Published](https://github.com/MohammedUmarAsif/solgeo-segment) |
...
All seven reusable implementations are now separate public repositories, each using
